...
class TestImportStatement(TransactionCase):
    ...
    def test_import_ofx_default(self):
        ...
        self.assertEqual(stmt.balance_start, 10.0)
        self.assertEqual(round(stmt.balance_end_real, 2), 914.45)
        self.assertEqual(stmt.balance_end, 914.45)
    ...
    def test_import_ofx_bb(self):
        ...
        self.assertEqual(stmt.balance_start, 172.61)
        self.assertEqual(round(stmt.balance_end_real, 2), 338.13)
        self.assertEqual(stmt.balance_end, 338.13)
    ...
    def test_import_ofx_itau(self):
        ...
        self.assertEqual(stmt.balance_start, -2690.0)
        self.assertEqual(round(stmt.balance_end_real, 2), -10081.58)
        self.assertEqual(stmt.balance_end, -10081.58)
