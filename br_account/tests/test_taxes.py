...
class TestTaxBrasil(TestBaseBr):
    ...
    def test_simple_tax_pis_cofins(self):
        ...
        self.assertEqual(res['total_excluded'], 200.0)
        self.assertEqual(res['total_included'], 200.0)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 10.0)

        res = self.cofins_1500.compute_all(100.0)
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 100.0)
        self.assertEqual(len(res['taxes']), 1)
    ...
    def test_ipi_tax(self):
        ...
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 107.0)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 7.0)

        res = self.ipi_700.with_context(ipi_reducao_bc=10.0).compute_all(100.0)
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 106.3)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 6.3)

        res = self.ipi_700.with_context(
            ipi_reducao_bc=10.0, valor_frete=20).compute_all(100.0)
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 107.56)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 7.56)

        res = self.ipi_700.with_context(
            ipi_reducao_bc=10.0, valor_seguro=30).compute_all(100.0)
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 108.19)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 8.19)

        res = self.ipi_700.with_context(outras_despesas=30).compute_all(100.0)
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 109.1)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 9.1)
    ...
    def test_normal_icms(self):
        ...
        self.assertEqual(res['total_included'], 100.0)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 17.0)
        ...
        self.assertEqual(res['total_included'], 100.0)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 15.3)
        ...
        self.assertEqual(res['total_included'], 100.0)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 16.065)
        ...
        self.assertEqual(res['total_included'], 100.0)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 16.524)
        ...
        self.assertEqual(res['total_included'], 100.0)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 16.32)

    def test_icms_st(self):
        res = self.icms_st_1800.compute_all(100.0)
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 118.0)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 18.0)

    def test_icms_st_incluso(self):
        res = self.icms_st_1800_incluso.compute_all(100.0)
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 121.95)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 21.95)

    def test_icms_st_and_icms(self):
        taxes = self.icms_1700 | self.icms_st_1800
        res = taxes.compute_all(100.0)
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 101.0)
        self.assertEqual(len(res['taxes']), 2)
        self.assertEqual(res['taxes'][0]['amount'], 1.0)  # ICMS ST
        self.assertEqual(res['taxes'][1]['amount'], 17.0)  # ICMS
    ...
    def test_icms_with_ipi_base(self):
        ...
        self.assertEqual(res['total_included'], 107.0)
        self.assertEqual(len(res['taxes']), 2)
        self.assertEqual(res['taxes'][0]['amount'], 7.0)  # IPI
        self.assertEqual(res['taxes'][1]['amount'], 18.19)  # ICMS
    ...
    def test_icmsst_negativo(self):
        ...
        self.assertEqual(res['taxes'][0]['amount'], 0.0)  # ICMS ST
        self.assertEqual(res['taxes'][1]['amount'], 17.0)  # ICMS
    ...
    def test_icms_com_mva(self):
        ...
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 107.3)
        self.assertEqual(len(res['taxes']), 2)

        self.assertEqual(res['taxes'][0]['amount'], 7.3)  # ICMS ST
        self.assertEqual(res['taxes'][1]['amount'], 17.0)  # ICMS
    ...
    def test_icmsst_mva_reducao_base(self):
        ...
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 106.09)
        self.assertEqual(len(res['taxes']), 2)

        self.assertEqual(res['taxes'][0]['amount'], 6.09)  # ICMS ST
        self.assertEqual(res['taxes'][1]['amount'], 17.0)  # ICMS
    ...
    def test_icmsst_mva_reducao_base_frete(self):
        ...
        self.assertEqual(res['total_included'], 107.0)
        self.assertEqual(len(res['taxes']), 2)
        self.assertEqual(res['taxes'][0]['amount'], 7.00)  # ICMS ST
        self.assertEqual(res['taxes'][1]['amount'], 19.55)  # ICMS
    ...
    def test_icmsst_mva_reducao_seguro(self):
        ...
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 107.61)
        self.assertEqual(len(res['taxes']), 2)
        self.assertEqual(res['taxes'][0]['amount'], 7.61)  # ICMS ST
        self.assertEqual(res['taxes'][1]['amount'], 21.25)  # ICMS
    ...
    def test_icmsst_mva_reducao_despesa(self):
        ...
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 107.91)
        self.assertEqual(len(res['taxes']), 2)

        self.assertEqual(res['taxes'][0]['amount'], 7.91)  # ICMS ST
        self.assertEqual(res['taxes'][1]['amount'], 22.1)  # ICMS
    ...
    def test_tax_issqn(self):
        ...
        self.assertEqual(res['total_included'], 100.0)
        self.assertEqual(len(res['taxes']), 1)
        self.assertEqual(res['taxes'][0]['amount'], 5.0)
    ...
    def test_tax_difal(self):
        ...
        self.assertEqual(res['total_included'], 100.0)
        self.assertEqual(len(res['taxes']), 2)
        self.assertEqual(res['taxes'][0]['amount'], 7.0)  # Remetente
        self.assertEqual(res['taxes'][1]['amount'], 3.0)  # Destinatário
    ...
    def test_tax_difal_por_dentro(self):
        ...
        self.assertEqual(res['total_included'], 100.0)
        self.assertEqual(len(res['taxes']), 2)
        self.assertEqual(res['taxes'][0]['amount'], 5.12)  # Remetente
        self.assertEqual(res['taxes'][1]['amount'], 2.2)  # Destinatário
    ...
    def test_difal_fcp(self):
        ...
        self.assertEqual(res['total_excluded'], 100.0)
        self.assertEqual(res['total_included'], 100.0)
        self.assertEqual(len(res['taxes']), 3)
        self.assertEqual(res['taxes'][0]['amount'], 0.0)  # Remetente
        self.assertEqual(res['taxes'][1]['amount'], 10.0)  # Destinatário
        self.assertEqual(res['taxes'][2]['amount'], 2.0)  # FCP
    ...
    def test_difal_fcp_reducao_frete_seguro_despesas(self):
        ...
        self.assertEqual(len(res['taxes']), 3)
        self.assertEqual(res['taxes'][0]['amount'], 0.0)  # Remetente
        self.assertEqual(res['taxes'][1]['amount'], 11.20)  # Destinatário
        self.assertEqual(res['taxes'][2]['amount'], 2.24)  # FCP
