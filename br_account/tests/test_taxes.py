...
class TestTaxBrasil(TestBaseBr):
    ...
    def test_difal_fcp(self):
        ...
        self.assertEqual(res['taxes'][0]['amount'], 2.0)  # Remetente
        self.assertEqual(res['taxes'][1]['amount'], 8.0)  # Destinatário
    ...
    def test_difal_fcp_reducao_frete_seguro_despesas(self):
        ...
        self.assertEqual(res['total_included'], 100.0)
        self.assertEqual(len(res['taxes']), 3)
        self.assertEqual(res['taxes'][0]['amount'], 2.24)  # Remetente
        self.assertEqual(res['taxes'][1]['amount'], 8.96)  # Destinatário
